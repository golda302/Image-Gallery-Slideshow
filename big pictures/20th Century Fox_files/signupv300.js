...
function signupHandler(genres) {
    ...
    var url = '//www.foxmovies.com/recommendations';
    var data = {
...
FoxSignup.prototype.translateTexts = function(translation){
    this.emailRequiredText = translation.emailRequiredText;
    this.emailFormatText = translation.emailFormatText;
    this.firstNameInvalidChars = translation.firstNameInvalidChars;
    this.lastNameInvalidChars = translation.lastNameInvalidChars;
}
...
FoxSignup.prototype.ajaxCallback = function(data){
    ...
    var  outter = $('<div>');
    var title = $('<h2>');
    title.text('Some movies you might like:');
    title.addClass('movie-recommendation-title');
    outter.append(title);
    for(var i=0;i<data.length; i++){
        ...
        outter.append(movieDiv);
    }
    // this.form.html(this.thankYouMessage);
    this.form.html(outter);
};
...
FoxSignup.prototype.ajaxSignup = function( url, data, signupType, genres  ) {
    ...
    if (!data.ri_url) data.ri_url = url;
